                    ...
                    <div className="idea-section">
                        <Container className='p-0'>
                            ...
                            <Row className="section-title">
                                <Col md={6}>
                                    <p>The Idea behind the project is to give back the reign to the buyer on what avatar they’ll use for the Metaverse. Like in character creation programs and RPGs, the buyer can choose the attributes they want from their collections of clothes and accessories. The buyer also has a choice of different avatars that they can buy from the catalog in Paras.</p>

                                </Col>
                                <Col md={6}>
                                    <p>After procuring an avatar, a background and at least 3 accessories, the buyer can submit a ticket in the NGC Discord server to merge their assets into one Haute Gang Picture. The team will work on a maximum of 50 a week merges that will be based on the ticket queue, and then transfer the minted Haute Gang to its respective owner.</p>
                                </Col>
                            </Row>
                        </Container>
                    </div>
