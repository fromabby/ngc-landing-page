                        ...
                        <Container style={{color: 'white', marginTop: '-30px', zIndex: '1'}}>
                            <Row>
                                <Col md={4} style={{marginBottom: '50px'}}>
                                    ...
                                    <p className='pt-4'>The team will pick a charity of its choosing to award a portion of the sales. The suggestions of the community will be greatly considered, especially the vote of the Haute Gang.</p>
                                ...
                                <Col md={4} style={{marginBottom: '50px'}}>
                                    ...
                                    <p className='pt-4'>NEAR Gang Couture thrives in a community of artists. It aims to help struggling and upstart artists in the space by giving them a “Blue Dot Cutie” moment where the fund personally purchases art from them, and helps promote it using its platform.</p>
                                    <p>This will be managed by a fund manager who will also be responsible for awarding new artists .10N+ for them to start their wallet and be able to mint their art pieces as well.</p>
                                </Col>
